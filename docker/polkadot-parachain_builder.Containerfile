# This file is sourced from https://github.com/Multiledgers/polkadot.git/blob/master/scripts/ci/dockerfiles/polkadot/polkadot_builder.Dockerfile
...
LABEL io.parity.image.type="builder" \
    ...
    io.parity.image.source="https://github.com/Multiledgers/polkadot.git/blob/${VCS_REF}/scripts/ci/dockerfiles/polkadot/polkadot-parachain_builder.Dockerfile" \
